...
<?php if(!empty($messages)):?>
	...
	<div class="page_sub_content">
		...
		<div class="arm_add_new_item_box" style="margin: 0 0 20px 0;">			
			<a class="greensavebtn arm_add_new_message_btn" href="javascript:void(0);" style="margin-right:20px;"><img align="absmiddle" src="<?php echo MEMBERSHIPLITE_IMAGES_URL ?>/add_new_icon.png"><span><?php _e('Add New Response', 'ARMember') ?></span></a>
		</div>
		<div class="armclear"></div>
			...
			<tr class="popup_wrapper_inner">	
				...
				<td class="popup_content_btn popup_footer">
					<div class="popup_content_btn_wrapper">
						<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" id="arm_loader_img_temp" class="arm_loader_img" style="position: relative;top: 15px;display: none;float: <?php echo (is_rtl()) ? 'right' : 'left';?>;" width="20" height="20" />
