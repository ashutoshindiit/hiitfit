					...
					<table class="form-table">
						...
						<tr class="form-field">
							...
							<td class="arm-form-table-content">
								...
								<button id="arm_user_import_btn" class="armemailaddbtn" name="arm_action" value="user_import" type="submit"><?php _e('Import', 'ARMember');?></button>&nbsp;<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" class="arm_loader_img_import_user" style="position:relative;top:8px;display:none;" width="24" height="24" />
							</td>
						</tr>
                        <tr class="form-field">
                            <td colspan="2">
        ...
        <div class="popup_wrapper_inner" style="overflow: hidden;">
            ...
            <div class="popup_content_btn popup_footer">
                ...
                <div class="popup_content_btn_wrapper">
                    <img src="<?php echo MEMBERSHIPLITE_IMAGES_URL . '/arm_loader.gif'; ?>" class="arm_loader_img" style="position: relative;top: 15px;display: none;float: <?php echo (is_rtl()) ? 'right' : 'left'; ?>;" width="20" height="20"/>
